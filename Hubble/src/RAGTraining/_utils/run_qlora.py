...
try:
    ...
    os.system("pip install flash-attn==2.4.2")
except:
...
def training_function(script_args, training_args):
    ...
    # model = MistralForCausalLM.from_pretrained(script_args.model_id,
    #                                    config=MistralConfig(), 
    ...
    tokenizer = AutoTokenizer.from_pretrained(script_args.model_id, padding_side="left", trust_remote_code=True)
