...
class FinetuneLLM:
    ...
    def __init__(self, model_id, finetune_id, training_input_path, epochs=2, batch_size=3, learning_rate='2e-4', merge_adapters=False, instance='ml.g5.2xlarge', region='ap-south-1'):
